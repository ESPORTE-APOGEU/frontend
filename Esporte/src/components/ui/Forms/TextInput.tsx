...
const TextInput: React.FC<Props> = ({ label, className, placeholder, onChangeText, value, ...props }) => (
    <View className="mb-4 w-full items-center font-[Poppins-Regular]">
        ...
        <RNTextInput
            ...
            className={`h-10 bg-neutral-100/75 rounded-lg border-gray-100 ${className ?? ''}`}
